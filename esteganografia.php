  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Esteganografia</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Esteganografia</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <!-- Map card -->
              <div class="card bg-light d-flex flex-fill">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b>Esteganografia LSB</b></h2>
              ...
              <form enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Mensagem" placeholder="Mensagem"  required>
                  </div>
                  <div class="form-group">
            ...
            <div class="card card-secondary">
              ...
              <form enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="Mensagem">Mensagem</label>
                    <input type="text" class="form-control" id="Mensagem" placeholder="Mensagem"  disabled>
                  </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
